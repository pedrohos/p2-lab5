...
/**
 * Representacao do controlador de clientes do sistema. O controlador gerencia
 * um conjunto de clientes do mapa cpf do cliente, Cliente.
 * 
...
public class ControllerCliente {
	...
	/**
	 * Verifica se um cliente existe no mapa clientes a partir de seu cpf. Retorna
	 * um boolean indicando true caso o cliente exista, caso contrario, false.
	 * 
	 * @param cpf e o cpf do cliente a ser verificado se esta ligada a algum cliente
	 *            no mapa clientes.
	...
	/**
	 * Adiciona um cliente ao mapa de clientes a partir de seu cpf, que sera seu
	 * identificador unico. O cliente e criado a partir de um cpf, nome, email e
	 * localizacao. Caso a adicao tenha sido efetuada com sucesso sera retornado o
	 * cpf.
	 * 
	 ...
	 * localizacao nao pode ser vazia ou nula." Caso o cpf ja exista sera lancado um
	 * IllegalArgumentException: "Erro no cadastro do cliente: cliente ja existe."
	 * 
	 * @param cpf         e o cpf do cliente que sera utilizado como seu
	 *                    identificado unico no mapa clientes.
	...
	/**
	 * Retorna a representacao toString do cliente a partir de seu cpf, formato: CPF
	 * - LOCALIZACAO - EMAIL
	 * 
	 * Caso o cpf seja nulo ou vazio sera lancado um IllegalArgumentException: "Erro
	 * na exibicao do cliente: cpf nao pode ser vazio ou nulo." Caso o cpf nao
	 * exista ser lancado um IllegalArgumentException: "Erro na exibicao do cliente:
	 * cliente nao existe."
	 * 
	 * @param cpf e o cpf do cliente que sera utilizado para recuperar o cliente no
	 *            mapa clientes.
	 ...
	 * um novo valor. O cpf e utilizado para recuperar o cliente no mapa clientes. O
	 * valor do atributo indicado sera substituido pelo valor recebido por
	 * parametro. Caso a edicao tenha sido efetuada com sucesso sera retornado o
	 * nome do atributo que foi alterado. O cpf nao pode ser alterado.
	 * 
	 * Caso o cpf seja nulo ou vazio sera lancado um IllegalArgumentException: "Erro
	 * na edicao do cliente: cpf nao pode ser vazio ou nulo." Caso o atributo seja
	 * nulo ou vazio sera lancado um IllegalArgumentException: "Erro na edicao do
	 * cliente: atributo nao pode ser vazio ou nulo." Caso o valor seja nulo ou
	 * vazio sera lancado um IllegalArgumentException: "Erro na edicao do cliente:
	 * novo valor nao pode ser vazio ou nulo." Caso o cpf tente ser alterado sera
	 * lancado um IllegalArgumentException: "Erro na edicao do cliente: cpf nao pode
	 * ser editado." Caso o atributo nao exista ser lancado um
	 * IllegalArgumentException: "Erro na edicao do cliente: atributo nao existe."
	...
	/**
	 * Lista todos os clientes pela sua representacao toString, no formato: CPF1 -
	 * EMAIL1 - LOCALIZACAO1 | CPF2 - EMAIL2 - LOCALIZACAO2 | CPFN - EMAILN -
	 * LOCALIZACAON
	 * 
	 ...
	 * 
	 * Caso o cpf seja vazio ou nulo sera lancado um IllegalArgumentException: "Erro
	 * na remocao do cliente: cpf nao pode ser vazio ou nulo" Caso o cliente nao
	 * exista ser lancado um IllegalArgumentException: "Erro na remocao do cliente:
	 * cliente nao existe."
	 * 
